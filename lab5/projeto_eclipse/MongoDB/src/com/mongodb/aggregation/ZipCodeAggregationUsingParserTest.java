...
public class ZipCodeAggregationUsingParserTest {
    public static void main(String[] args) {
        ...
        */
        ...
        List<Document> pipeline =new ArrayList<Document>();
       	pipeline.add(Document.parse("{ $group: { _id: '$state', totalPop: { $sum: '$pop' } } }"));
       	pipeline.add(Document.parse("{ $match: { totalPop: { $gte: 10000000 } } }"));
